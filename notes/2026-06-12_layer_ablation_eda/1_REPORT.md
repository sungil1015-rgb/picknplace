...
원본 raw 결과: [`2_raw_results.md`](2_raw_results.md)
...
![AUROC vs layer](figs/auroc_vs_layer.png)
...
raw 표는 [`2_raw_results.md`](2_raw_results.md) 참조.
...
산출물 시각화 (이 폴더 안):
- `figs/auroc_vs_layer.png` (한 장 요약)
- `figs/roc_curves_{class}.png` (클래스별 11 layer ROC 곡선)
- `figs/score_dist_{class}.png` (클래스별 11 layer score 분포)
